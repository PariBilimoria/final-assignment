...
You will need to create a register.html page that is linked to from the "Sign Up Now!" hyperlink on the index.html and a contact-us.html page that will be linked to from "Contact" hyperlink on each page.
